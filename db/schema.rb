...
ActiveRecord::Schema.define(version: 2021_02_07_014823) do
  ...
  create_table "attachfiles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["assignment_id"], name: "index_attachfiles_on_assignment_id"
    t.index ["user_id"], name: "index_attachfiles_on_user_id"
  end
  ...
  add_foreign_key "attachfiles", "assignments"
  add_foreign_key "attachfiles", "users"
